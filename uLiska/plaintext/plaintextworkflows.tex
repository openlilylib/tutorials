...
You can organize style and layout templates in a hierarchical and sophisticated way and have all files share some common styles (like font selections) but have different additional styles for different output formats (full scors, part, music example \dots).
...
Combine this with the fact that all your manual interventions are written explicitely in the file and compare that with the situation of a graphical score editing program where you can hardly tell in backsight what your manual interventions are \dots
...
This way you will be able to do all your work \emph{within the actual score}, and finally you will get the entries for the critical report nicely formatted as source text to be used in the corresponding \LaTeX{} document!
...
\item Output quality \emph{and} workflow
\item import/export :-(
\end{itemize}
