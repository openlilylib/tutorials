...
% suggestion: mention that when software becomes unsupported,
...
% another spectacular example: person A changes something in foo.txt
% while person B renames foo.txt to bar.txt - git automatically merges
% such changes.
