...
and wouldn't even consider there is a different possibility at all.
...
If you know of or find interesting introductions on any level feel free to tell me so I can enhance the list.

\section*{Plain Text}

\url{http://www.terminally-incoherent.com/blog/2012/05/21/why-plain-text/} is a blog post that I have read only after having written this document. I think it tells you everything again that I have written on the characteristics of plain text files, from a different perspective and maybe even more convincing.
...
On Windows you can also get it bundled with one of the GUI tools
\end{itemize*}
There are numerous GUI tools around, a number of them collected on \url{http://git-scm.com/downloads/guis}.
But I recommend starting to use it on the command line because this way you will faster get an understanding of what's happening exactly.
...
Of particular interest for now is the 
...
So after the score files you'll see the text document and then its corresponding base files (first pages) from:
