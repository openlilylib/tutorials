...
This way you can easily navigate your text file(s) which could have been somewhat difficult when this wasn't available yet.

Current development of Frescobaldi focuses on enhancement of the music view's functionality.
So it will soon be possible to “edit” the score with the mouse---of course in fact you will be able to tweak something visually and Frescobaldi will insert the appropriate text in the source file, possibly giving you the option to select from different approaches.
Currently there are plans to implement correcting pitches, shaping curves, and annotating objects (see also \fref{sec:pt_lilypond-comments}).
...
A thorough introduction can't be the intention of this paper, but I wanted to give you a feeling to what extent smart editors can smoothen your editing experience.
...
In \fref{fig:pt_fb-main-window} you have seen a short score excerpt from Brahms' first violin sonata, along with the LilyPond code that produced it.
