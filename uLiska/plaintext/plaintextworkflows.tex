...
The technical infrastructure of a versioned workflow doesn't impose any restrictions on the order of the steps beyond what is immanent in the task (it doesn't make sense for example to fine-tune the engraving while there are still revisions in process that might change the content).
